        ...
        if (getc(f1) == '\n')
        {
            ...
            for (i = 0; i < t; i++)
            {
                if (strcmp(tab[i].name, "DL") == 0 && strcmp(tab[i + 1].name, "1") == 0)
                {
                    if (strcmp(tab[i + 2].name, "l") == 0)
                    {
                        ...
                        {
                            fscanf(f3, "\n%s %s %d %d", type, tname, &t1, &t2);
                            if (strcmp(type, "l") == 0 && atoi(tab[i + 3].name) == t1)
                            {
                                printf(" 0 0 %s", tname);
            ...
            if (nl != 1)
            {
                for (i = 0; i < t; i++)
                {
                    ...
                    else if (strcmp(tab[i].name, "IS") == 0 || strcmp(tab[i].name, "-") == 0 || strcmp(tab[i].name, "R") == 0)
                        printf("");
                    else if (strcmp(tab[i].name, "s") == 0)
                    {
                        ...
                        {
                            fscanf(f3, "\n%s %s %d %d", type, tname, &t1, &t2);
                            if (strcmp(type, "s") == 0 && atoi(tab[i + 1].name) == t1)
                            {
                                printf(" %d", t2);
                                fprintf(f2, " %d", t2);
                                i = i + 1;
                    ...
                    else if (strcmp(tab[i].name, "l") == 0)
                    {
                        ...
                        {
                            fscanf(f3, "\n%s %s %d %d", type, tname, &t1, &t2);
                            if (strcmp(type, "l") == 0 && atoi(tab[i + 1].name) == t1)
                            {
                                if (i != 1)
                                {
                                    printf(" %d", t2);
